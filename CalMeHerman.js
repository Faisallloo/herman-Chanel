...
petik = '```'
fake = '©FAISAL'//GANTI NAMA KAMU BEP
ban =[]
...
*Saran CN :* KALO DH JOIN GUA KASIH TAU
...
//------------------< Menunya Bang:v >-------------------
      case 'dana':
         ...
         case 'pulsa':
             ...
             break              
      case 'infoig':
             reply(`Follow Instagram Owner Ya : BELOM ADA IG KAK`)
             break
      case 'grupbot':
